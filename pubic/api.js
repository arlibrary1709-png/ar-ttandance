...
const API = {
  ...
  // ════════════════════════════════════════════════════
  //  CIRCLEX AI (GEMINI PROXY)
  // ════════════════════════════════════════════════════

  /**
   * Send a message to CircleX AI via server proxy
   * @param {object} payload - { system_instruction, contents, generationConfig }
   */
  async gemini({ system_instruction, contents, generationConfig = { maxOutputTokens: 8000 } }) {
